<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="WebApplication5.ResetPaswordaspx" %>
...
&nbsp;<asp:CompareValidator ID="cmpv_Con_Pwd" runat="server" ControlToCompare="txt_New_Pwd" ControlToValidate="txt_Confirm_Pwd" ErrorMessage="PWD NOT MATCHED" SetFocusOnError="True"></asp:CompareValidator>
                ...
                <tr>
                    <td class="auto-style4">
                        <asp:LinkButton ID="Lnk_Back_SignIn" runat="server" ForeColor="Black" CausesValidation="False" OnClick="Lnk_Back_SignIn_Click">BACK TO SIGN IN</asp:LinkButton>
                    </td>
                    <td class="auto-style3">
                        <asp:Button ID="Btn_Reset_Pwd" runat="server" Text="RESET" OnClick="Btn_Reset_Pwd_Click" />
                        <asp:Button ID="Btn_Cancel" runat="server" CausesValidation="False" Text="CANCEL" OnClick="Btn_Cancel_Click" />
                    </td>
                </tr>
            </table>
        </div>
