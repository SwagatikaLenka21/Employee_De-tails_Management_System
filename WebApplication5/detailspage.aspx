<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="detailspage.aspx.cs" Inherits="WebApplication5.WebForm3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style9">EMP_ID</td>
                    <td class="auto-style8">
                        <asp:TextBox ID="txt_Id" runat="server" CssClass="dr" Font-Bold="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style9">&nbsp;</td>
                    <td class="auto-style8">
                        <asp:Button ID="Btn_Save" runat="server" Font-Bold="True" Width="100px" Height="20px" Text="SAVE" OnClick="Btn_Save_Click1" />
                        <asp:Button ID="Btn_Cancel" runat="server" Font-Bold="True" Width="100px" Height="20px" Text="CANCEL" OnClick="Btn_Cancel_Click" />
                    </td>
                </tr>
                <tr>
                    <td class="auto-style9">&nbsp;</td>
                    <td class="auto-style3">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" 
                            GridLines="None" OnPageIndexChanging="Disp" OnRowCancelingEdit="Cancel" OnRowEditing="Edit">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="EDIT">
                                    <ItemTemplate>
                                        <asp:Button ID="Btn_Edit" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Emp_Id") %>' Text="EDIT" OnClick="Btn_Edit_Click" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="REMOVE">
                                    <ItemTemplate>
                                        <asp:Button ID="Btn_Delete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Emp_Id") %>' Text="DELETE" OnClick="Btn_Delete_Click" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
